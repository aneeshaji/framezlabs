...
import { PartyPopper, ArrowRight, Sparkles, X } from 'lucide-react';
...
export const NewYearBanner = () => {
    ...
    useEffect(() => {
        // Check if banner was manually closed by user
        ...
        // Define the display period: Dec 31, 2025 to Jan 2, 2026 (2 days)
        const startDate = new Date('2025-12-31T00:00:00');
        const endDate = new Date('2026-01-02T23:59:59');
        const currentDate = new Date();

        // Check if current date is within the display period
