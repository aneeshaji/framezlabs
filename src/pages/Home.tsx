...
import { ArrowRight, Star, Heart, ShieldCheck, Truck, Gift, CheckCircle, MessageCircle, Sparkles, Baby, Cake, Users } from 'lucide-react';
                    ...
                    >
                        {CATEGORIES.slice(0, 8).map((cat, index) => (
                            ...
                            >
                                ...
                                >
                                    <h4 style={{ fontSize: '1.25rem', marginBottom: 0, fontWeight: 600 }}>{cat}</h4>
                                </Link>
                            </motion.div>
                        ))}
                        <motion.div variants={fadeInUp}>
                            <Link to="/products" className="glass-card flex items-center justify-center text-teal"
                                style={{
                                    fontWeight: 'bold',
                                    height: '100%',
                                    minHeight: '160px',
                            ...
                            >
                                View All <ArrowRight size={20} style={{ marginLeft: '0.5rem' }} />
                            </Link>
                        </motion.div>
                    </motion.div>
                </div>
